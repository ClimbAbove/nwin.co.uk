        ...
        <div class="grid-x">
            <div class="logo_container large-4 small-2">
                <a href="{{route('page-home')}}">
                    <svg width="80" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 161.809 201.567" fill="#1A90D9">
                        <path stroke="#1A90D9" stroke-miterlimit="10" stroke-width="4" d="M3 3h156v217H3z"/>
                        <g fill="#FFF">
